...
public class ZwbHistoryCorpBean
{
  private long[] kills;
  ...
  public ZwbHistoryCorpBean(long[] kills, long[] losses, double[] kdratio, double[] kdefficiency, double[] iskwon, double[] isklost, double[] netisk,
                            double[] iskefficiency, long[] numactive, double[] avgperkill, double[] iskperactive, double[] netiskperactive,
                            double[] iskperavgonkill, double[] netiskperavgonkill)
  {
    this.kills = kills;
    this.losses = losses;
